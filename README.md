...
- **Modules:** Spring Web MVC, Data JPA, Data MongoDB, Validation, Cache, REST Client, Security, Actuator, Resilience (Circuit Breaker)
...
- **Infrastructure:** Docker, Docker Compose, AWS S3 (mocked via LocalStack)
